    ...
    public class DbSeeder
    {
        public static async Task SeedUser(IServiceProvider serviceProvider)
        {
            using (var scope = serviceProvider.CreateScope())
            {
                ...
                await CreateUserIfNotExist(userManager, "umeshtripathi369@gmail.com", "Umesh Raj Tripathee", SD.Role_User_Admin, "9823683346");
                await CreateUserIfNotExist(userManager, "customer123@gmail.com", "Umesh Raj Tripathee", SD.Role_User_Cust, "123456789");
            }
        }
        ...
        private static async Task CreateUserIfNotExist(UserManager<IdentityUser> userManager, string email, string name, string roleName, string phoneNumber)
        {
            if (await userManager.FindByEmailAsync(email) == null)
            {
                ...
                var result = await userManager.CreateAsync(newUser, "@Umesh123");
